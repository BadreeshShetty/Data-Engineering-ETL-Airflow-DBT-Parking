  ...
  create or replace   view PARKING_DB.PARKING_SCHEMA.silver_parking_violations_MN
...
SELECT * FROM enhanced_data
),  __dbt__cte__silver_merge_all_parking_violations as (
SELECT * FROM __dbt__cte__bronze_parking_violations_2014
UNION ALL
SELECT * FROM __dbt__cte__bronze_parking_violations_2015
UNION ALL
...
FROM
    __dbt__cte__silver_merge_all_parking_violations
  );
