...
enhanced_data AS (
    ...
    SELECT
        *,
        ...
        CASE
            WHEN violation_time::TIME BETWEEN TIME '00:00' AND TIME '06:00' THEN 'Late Night'
            WHEN violation_time::TIME BETWEEN TIME '06:01' AND TIME '12:00' THEN 'Morning'
            WHEN violation_time::TIME BETWEEN TIME '12:01' AND TIME '18:00' THEN 'Afternoon'
            ELSE 'Evening'
        END AS violation_time_of_day
    FROM base_data

)
SELECT * FROM enhanced_data
),  __dbt__cte__bronze_parking_violations_2015 as (
-- models/bronze/bronze_parking_violations.sql
WITH base_data AS (
...
SELECT * FROM enhanced_data
),  __dbt__cte__silver_merge_all_parking_violations_MN as (
SELECT * FROM 
...
FROM
    __dbt__cte__bronze_parking_violations_2014
...
SELECT
    ...
    END AS is_manhattan_96th_st_below
FROM
    __dbt__cte__bronze_parking_violations_2015
...
SELECT
    ...
    END AS is_manhattan_96th_st_below
FROM
    __dbt__cte__bronze_parking_violations_2016
...
from __dbt__cte__silver_merge_all_parking_violations_MN
